...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), dict(
  DESCRIPTOR = _HTTP,
  __module__ = 'github.com.grpc_ecosystem.grpc_gateway.third_party.googleapis.google.api.http_pb2'
